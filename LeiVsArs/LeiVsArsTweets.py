...
class TweetListener(tweepy.StreamListener):
    ...
    def __init__(self):
        ...
        self.collection = self.db["TwitterLCFCARS"]
...
tweet_stream.filter(track=['#AFC','@Arsenal','Arsenal', 'AFC','Wenger'
    ,'LCFCAFC','Arsene','Gunners','Gooner','Gooners','Xhaka'
    ,'LCFCvAFC','EPL','#EPL','#BPL','Premier League'
    ,'Alexis','Sanchez','Vardy','Mahrez','Musa','Cech'
    ,'KingPower','#LEIARS'
    ,'@LCFC','LCFC','Leicester','#LCFC'])
